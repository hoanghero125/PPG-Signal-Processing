...
if __name__ == "__main__":
    ...
    if config.TOOLBOX_MODE == "train_and_test":
        ...
        elif config.TRAIN.DATA.DATASET == "Custom":
            train_loader = data_loader.CustomLoader.CustomLoader
        else:
            raise ValueError("Unsupported dataset! Currently supporting UBFC-rPPG, PURE, MMPD, \
                             SCAMPS, BP4D+ (Normal and BigSmall preprocessing), UBFC-PHYS, iBVP, and Custom.")
        ...
        elif config.VALID.DATA.DATASET == "Custom":
            valid_loader = data_loader.CustomLoader.CustomLoader
    ...
    if config.TOOLBOX_MODE == "train_and_test" or config.TOOLBOX_MODE == "only_test":
        ...
        elif config.UNSUPERVISED.DATA.DATASET == "Custom":
            unsupervised_loader = data_loader.CustomLoader.CustomLoader
        else:
            raise ValueError("Unsupported dataset! Currently supporting UBFC-rPPG, PURE, MMPD, \
                             SCAMPS, BP4D+, UBFC-PHYS, iBVP, and Custom.")
